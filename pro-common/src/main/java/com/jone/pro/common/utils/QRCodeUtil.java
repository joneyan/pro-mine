...
public class QRCodeUtil {
    ...
    public static void main(String[] args) throws Exception {
        String text = "吴浩楠是我儿子";
        String destImage = PathUtils.getLocalPath()+"/image.jpg";
        String imagePath = "D:/ceshi.jpg";
        QRCodeUtil.encode(text,imagePath,destImage,Boolean.TRUE);
        String decode = QRCodeUtil.decode(destImage);
