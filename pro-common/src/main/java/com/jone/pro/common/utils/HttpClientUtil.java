...
public class HttpClientUtil {
    ...
    public static void main(String[] args) {
        ...
        headers.put("Authorization","token e207884147614dd0a0d027143dff5348");
        String result = doGet("https://api.51datakey.com/carrier/v3/mobiles/18268120839/mxdata?task_id=5df76bd0-198d-11e9-aa83-00163e004a23",null,headers);
